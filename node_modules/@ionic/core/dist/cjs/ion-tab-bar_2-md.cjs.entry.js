...
const TabButton = class {
    ...
    componentWillLoad() {
        if (this.layout === undefined) {
            this.layout = config.config.get('tabButtonLayout', 'icon-top');
        }
    }
    selectTab(ev) {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
                ...
                'ion-selectable': true,
                'ion-focusable': true
            } }, core.h("a", Object.assign({}, attrs, { tabIndex: -1 }), core.h("slot", null), mode === 'md' && core.h("ion-ripple-effect", { type: "unbounded" }))));
    }
    get el() { return core.getElement(this); }
