...
const renderIndeterminate = () => {
    return [
        core.h("div", { class: "indeterminate-bar-primary" }, core.h("span", { class: "progress-indeterminate" })),
        core.h("div", { class: "indeterminate-bar-secondary" }, core.h("span", { class: "progress-indeterminate" }))
    ];
};
const renderProgress = (value, buffer) => {
    ...
    return [
        core.h("div", { class: "progress", style: { transform: `scaleX(${finalValue})` } }),
        finalBuffer !== 1 && core.h("div", { class: "buffer-circles" }),
        core.h("div", { class: "progress-buffer-bar", style: { transform: `scaleX(${finalBuffer})` } }),
    ];
};
