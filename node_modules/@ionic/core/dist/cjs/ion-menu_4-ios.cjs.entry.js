...
`);
    ...
    onEnd(detail) {
         ...
         */
        newStepValue += cubicBezier.getTimeGivenProgression(new cubicBezier.Point(0, 0), new cubicBezier.Point(0.4, 0), new cubicBezier.Point(0.6, 1), new cubicBezier.Point(1, 1), helpers.clamp(0, adjustedStepValue, 1));
        this.animation
