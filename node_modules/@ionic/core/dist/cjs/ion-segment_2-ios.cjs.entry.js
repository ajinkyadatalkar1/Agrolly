...
const Segment = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'segment-disabled': this.disabled, 'segment-scrollable': this.scrollable }) }));
    }
...
const SegmentButton = class {
    ...
    render() {
        ...
        const mode = core.getIonMode(this);
        return (core.h(core.Host, { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, class: {
                [mode]: true,
            ...
            } }, core.h("button", { type: type, "aria-pressed": checked ? 'true' : null, class: "button-native", disabled: disabled }, core.h("slot", null), mode === 'md' && core.h("ion-ripple-effect", null)), core.h("div", { class: "segment-button-indicator" })));
    }
    get el() { return core.getElement(this); }
    static get watchers() { return {
