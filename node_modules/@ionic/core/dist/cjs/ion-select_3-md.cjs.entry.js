...
const Select = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { onClick: this.onClick, role: "combobox", "aria-haspopup": "dialog", "aria-disabled": disabled ? 'true' : null, "aria-expanded": `${isExpanded}`, "aria-labelledby": labelId, class: {
            ...
            } }, core.h("div", { class: selectTextClasses }, selectText), core.h("div", { class: "select-icon", role: "presentation" }, core.h("div", { class: "select-icon-inner" })), core.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: disabled, ref: (btnEl => this.buttonEl = btnEl) })));
    }
