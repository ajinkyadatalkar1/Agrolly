...
const Chip = class {
    ...
    render() {
        ...
        return (core.h(core.Host, { class: Object.assign(Object.assign({}, theme.createColorClasses(this.color)), { [mode]: true, 'chip-outline': this.outline, 'ion-activatable': true }) }, core.h("slot", null), mode === 'md' && core.h("ion-ripple-effect", null)));
    }
