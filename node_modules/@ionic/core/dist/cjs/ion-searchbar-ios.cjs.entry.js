...
const Searchbar = class {
    ...
    positionPlaceholder() {
        ...
        if (this.shouldAlignLeft) {
            ...
            tempSpan.innerHTML = index.sanitizeDOMString(this.placeholder) || '';
