...
const Checkbox = class {
    ...
    render() {
        ...
        let path = indeterminate
            ? core.h("path", { d: "M6 12L18 12" })
            : core.h("path", { d: "M5.9,12.5l3.8,3.8l8.8-8.8" });
        if (mode === 'md') {
            path = indeterminate
                ? core.h("path", { d: "M2 12H22" })
                : core.h("path", { d: "M1.73,12.91 8.1,19.28 22.79,4.59" });
        }
        return (core.h(core.Host, { onClick: this.onClick, role: "checkbox", "aria-disabled": disabled ? 'true' : null, "aria-checked": `${checked}`, "aria-labelledby": labelId, class: Object.assign(Object.assign({}, theme.createColorClasses(color)), { [mode]: true, 'in-item': theme.hostContext('ion-item', el), 'checkbox-checked': checked, 'checkbox-disabled': disabled, 'checkbox-indeterminate': indeterminate, 'interactive': true }) }, core.h("svg", { class: "checkbox-icon", viewBox: "0 0 24 24" }, path), core.h("button", { type: "button", onFocus: this.onFocus, onBlur: this.onBlur, disabled: this.disabled, ref: btnEl => this.buttonEl = btnEl })));
    }
